...
public class ZeroBank_Steps {
	...
	@Given("the user launches google")
	public void the_user_launches_google() {


	}


	@When("the user enters {string} in google search box")
	public void the_user_enters_in_google_search_box(String string) {
	...
	public void the_user_launches_url(String url) {
		driver = new ChromeDriver();
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		driver.get("https://www."+url+".co.in/");

	}
//	@Then("the user enters \"{value}\" in search bar")
//	public void the_user_enters_in_search_bar(String value) {
//		driver.findElement(By.xpath("//input[@name='q']")).sendKeys(value);
//	}
//	@Then("the user clicks on enter")
//	public void the_user_clicks_on_enter() {
